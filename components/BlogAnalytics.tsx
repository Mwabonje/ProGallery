...
import { TrendingUp, FileText, Loader2, Eye } from 'lucide-react';
    ...
    <div className="bg-white rounded-3xl p-6 md:p-8 mb-10 shadow-sm border border-slate-200">
      ...
      <div className="bg-slate-50 p-6 rounded-2xl border border-slate-100 mb-8">
        <div className="flex items-center gap-2 mb-6">
          ...
          <h3 className="text-lg font-semibold text-slate-800">Views by Post (All Time)</h3>
        </div>
                    ...
                    if (active && payload && payload.length) {
                      return (
                        <div className="bg-white p-3 border border-slate-200 rounded-xl shadow-lg">
                          <p className="font-medium text-slate-900 mb-1">{payload[0].payload.fullTitle}</p>
                          <p className="text-emerald-600 font-semibold">{payload[0].value} views</p>
                        </div>
                      );
                    }
                    return null;
