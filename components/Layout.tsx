      ...
      <div className="w-[240px] bg-[#F5F5F7] text-slate-600 h-screen sticky top-0 flex flex-col py-8 border-r border-slate-200/60 shrink-0 shrink-0">
        ...
        <div className="flex-1 overflow-y-auto space-y-8 no-scrollbar">
          <div>
            ...
            <div className="px-3">
              <div onClick={() => navigate('/dashboard')} className={`flex items-center px-3 py-2 rounded-md cursor-pointer transition-colors hover:text-black hover:bg-black/5`}>
          ...
          <div>
            ...
            <div className="px-3 space-y-0.5">
              <div onClick={() => navigate('/dashboard?view=galleries')} className={`flex items-center justify-between px-3 py-2 rounded-md cursor-pointer transition-colors group hover:text-black hover:bg-black/5`}>
              ...
              <div onClick={() => navigate('/dashboard?view=delivery')} className={`flex items-center justify-between px-3 py-2 rounded-md cursor-pointer transition-colors group ${isGalleryManager ? 'bg-black/5 text-black' : 'hover:text-black hover:bg-black/5'}`}>
                <div className="flex items-center">
                  <div className="w-[15px] h-[15px] mr-3" />
              ...
              <div onClick={() => navigate('/dashboard?view=blogs')} className={`flex items-center px-3 py-2 rounded-md cursor-pointer transition-colors hover:text-black hover:bg-black/5`}>
                <div className="w-[15px] h-[15px] mr-3" />
        ...
        <div className="pt-4 px-6 flex justify-between items-center gap-3">
          ...
          <button onClick={handleLogout} className="text-slate-400 hover:text-slate-900 transition-colors">
